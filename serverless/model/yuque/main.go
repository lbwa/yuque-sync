...
type DocDetailSerializer struct {
	Id              YuQueId        `json:"id,omitempty"`                 // 文档编号
	Slug            string         `json:"slug,omitempty"`               //文档路径
	Title           string         `json:"title,omitempty"`              //标题
	BookId          YuQueId        `json:"book_id,omitempty"`            //仓库编号，就是 repo_id
	Book            BookSerializer `json:"book,omitempty"`               //仓库信息 <BookSerializer>，就是 repo 信息
	UserId          YuQueId        `json:"user_id,omitempty"`            //用户/团队编号
...
type BookSerializer struct {
	Id           YuQueId        `json:"id,omitempty"`            // 仓库编号
	...
	UserId       YuQueId        `json:"user_id,omitempty"`       // 所属的团队/用户编号
	User         UserSerializer `json:"user,omitempty"`          // <UserSerializer>
	Description  string         `json:"description,omitempty"`   // 介绍
	CreatorId    YuQueId        `json:"creator_id,omitempty"`    // 创建人 User Id
...
type UserSerializer struct {
	Id        YuQueId `json:"id,omitempty"`         // 用户编号
